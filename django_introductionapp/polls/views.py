...
class IndexView(generic.ListView):
    ...
    def get_queryset(self): # es para obtener las preguntas
        ...
        return Question.objects.order_by("-pub_date")[:5] #order_by es igual a filter pero ordenado / El "-" antes de pub es para ordenar de la más reciente a la más vieja / [:5] es para mostrar solo 5
